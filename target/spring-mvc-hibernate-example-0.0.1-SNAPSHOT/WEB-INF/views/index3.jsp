		...
		<div class="page-inner">
			...
			<div role="main">
				<%@include file="/menu.jsp" %>
					<div id="matilda_header" style="background-image: url(<c:url value="/resources/images/banner2.jpg" />);display: inline-block;padding-top: 1rem; width: 100%;background: #0c304a;background: linear-gradient(to right bottom, #0c304a, #004466);">
						...
						<div style="float: left; width: 33.3%;text-align: right;height: 320px;">
							<img alt="" src="<c:url value="/resources/images/transparent-matilda.png" />" height="320px;">
						</div>
					</div>
