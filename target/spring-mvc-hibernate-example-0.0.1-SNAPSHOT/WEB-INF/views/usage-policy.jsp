...
<body>
	<div class="uomcontent">
			...
			<div class='main' id='main-content' role='main'>
				...
				<p>All images and data, where otherwise noted, are provided under a Creative Commons Attribution-Non Commercial (CC BY NC) 3.0 Australia license. This allows for re-use and re-distribution of the data
				and images and requires that the source of the data is acknowledged. </p>
		   </div>
