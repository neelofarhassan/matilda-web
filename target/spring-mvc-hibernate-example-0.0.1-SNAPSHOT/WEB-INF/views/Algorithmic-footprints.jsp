...
function showExecutionLogs(user, problem, modificationTime, lineNumber, logContents, methodCalls){
	...
	$.ajax({
		...
		success: function(data){
			$.each(data, function(k,v){
// 				console.log('outer index:' + k);
// 				console.log('outer value: ' + v);
				if(k == 'true'){
...
// 				});
			...
			if(endOfFile != 'true'){
				methodCalls = parseInt(methodCalls) + 1;
				 setTimeout(showExecutionLogs(user, problem, modificationTime, lineNumber, logContents, methodCalls), 10000);
			}else{
				return;
			}
		}
    ...
    <div class="page-inner">
      ...
      <div role="main">
		...
		<%@include file="/menu.jsp" %>
			<div id="logs" style="overflow:scroll; height:400px; padding-left: 200px; padding-right: 200px; border: 2px, solid, black;"></div>
