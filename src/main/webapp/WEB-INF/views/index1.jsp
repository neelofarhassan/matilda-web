	...
	<div class="uomcontent">
		<div class="page-inner">
			...
			<div role="main">
				...
				<div style="height:1000px; background-image: url(<c:url value="/resources/images/background/old-quad.png" />); background-size: cover; display: inline-block; width: 100%;background-repeat: no-repeat; color: white; background-attachment: fixed;text-align:center;">
					<div id="home_main_container" style="font-family : Comic Sans MS;font-size: 20px;">
					<h1 style="font-weight:300; font-size:36px; width: 48%;">Melbourne Algorithm & Test Instance Library with Data Analytics</h1>
						...
						related to MATILDA and source code for algorithms and feature generation.
					</div>
					<div id="homapage_buttons" style="border: 0px solid white; color:white; width: 60%; display: inline-block; text-align: center;">
