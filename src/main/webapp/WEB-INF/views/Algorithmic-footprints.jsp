      ...
      <div id="main_container">
		...
		<div class="shell-wrap" id="execution_logs_container">
			...
			<div id="graph_container" style="text-align: left;">
					...
					<form>
						<fieldset>
							<div class="twocolumnform_firstcolumn">
								<label><strong>Select a feature/algorithm:</strong></label>
								<div id='features' ></div>
							</div>
				...
				<div id="graph_body" style="width: 800px;height: 850px;margin-top: 50px;margin-left: 25%;"></div>
				<div id="graph_body2" style="width: 800px;height: 850px;margin-top: 50px;margin-left: 25%;"></div>
			</div>
			
			<div id="table_container" class="table_container hidden_div"></div>   
